...
const agregarComentario = (usuario_id, publicacion_id, comentario, callback) => {
    const query = 'INSERT INTO comentarios (usuario_id, publicacion_id, comentario) VALUES (?, ?, ?)';
    connection.query(query, [usuario_id, publicacion_id, comentario], (err, results) => {
        if (err) {
